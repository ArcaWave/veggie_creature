...
1. 두 PC 모두 크롬을 키오스크 모드로 (소리 자동 재생 허용):
   - 스캔 스테이션: `open -a "Google Chrome" --args --autoplay-policy=no-user-gesture-required --kiosk "https://veggie-creature.vercel.app/"`
   - 월드: `open -a "Google Chrome" --args --autoplay-policy=no-user-gesture-required --kiosk "https://veggie-creature.vercel.app/world.html"`
